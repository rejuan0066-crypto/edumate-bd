...
const AdminStaffForm = () => {
  ...
  if (isEditMode && existingStaff && !dataLoaded) {
    ...
    if (sd.identifier) {
      const i = sd.identifier;
      setIdentifierName(i.name || '');
      setIdentifierRelation(i.relation || '');
      setIdentifierMobile(i.mobile || '');
      setIdentifierMobileCode(i.mobile_code || '+880');
      setIdentifierNid(i.nid || '');
      if (i.address) setIdentifierAddr(i.address);
    }
