...
export const DEFAULT_DESIGN: ReceiptDesignConfig = {
  ...
  duplicateCopy: true,
  elements: [
    { id: 'logo', type: 'logo', x: 10, y: 6, width: 32, height: 32, content: '' },
    { id: 'inst_name', type: 'text', x: 46, y: 6, width: 190, height: 16, content: '{institution_name}', fontSize: 13, fontWeight: 'bold', color: '#000000', textAlign: 'center', fontFamily: 'bengali' },
    { id: 'inst_addr', type: 'text', x: 46, y: 22, width: 190, height: 10, content: '{institution_address}', fontSize: 8, color: '#666666', textAlign: 'center', fontFamily: 'bengali' },
    { id: 'hr1', type: 'line', x: 10, y: 36, width: 260, height: 2, color: '#333333', borderWidth: 1 },
    { id: 'title', type: 'text', x: 80, y: 38, width: 120, height: 14, content: 'ফি রিসিট', fontSize: 11, fontWeight: 'bold', color: '#333333', textAlign: 'center', fontFamily: 'bengali' },
    { id: 'name_label', type: 'text', x: 10, y: 56, width: 45, height: 13, content: 'নাম:', fontSize: 9, fontWeight: 'bold', color: '#555555', fontFamily: 'bengali', textAlign: 'right' },
    { id: 'name_val', type: 'placeholder', x: 58, y: 56, width: 110, height: 13, placeholder: '{student_name}', fontSize: 9, color: '#111111', fontFamily: 'bengali' },
    { id: 'id_label', type: 'text', x: 10, y: 70, width: 45, height: 13, content: 'আইডি:', fontSize: 9, fontWeight: 'bold', color: '#555555', fontFamily: 'bengali', textAlign: 'right' },
    { id: 'id_val', type: 'placeholder', x: 58, y: 70, width: 110, height: 13, placeholder: '{student_id}', fontSize: 9, color: '#111111', fontFamily: 'bengali' },
    { id: 'roll_label', type: 'text', x: 10, y: 84, width: 45, height: 13, content: 'রোল:', fontSize: 9, fontWeight: 'bold', color: '#555555', fontFamily: 'bengali', textAlign: 'right' },
    { id: 'roll_val', type: 'placeholder', x: 58, y: 84, width: 110, height: 13, placeholder: '{roll_no}', fontSize: 9, color: '#111111', fontFamily: 'bengali' },
    { id: 'fee_label', type: 'text', x: 10, y: 98, width: 45, height: 13, content: 'ফি ধরন:', fontSize: 9, fontWeight: 'bold', color: '#555555', fontFamily: 'bengali', textAlign: 'right' },
    { id: 'fee_val', type: 'placeholder', x: 58, y: 98, width: 110, height: 13, placeholder: '{fee_type}', fontSize: 9, color: '#111111', fontFamily: 'bengali' },
    { id: 'amount_label', type: 'text', x: 10, y: 112, width: 45, height: 14, content: 'পরিমাণ:', fontSize: 10, fontWeight: 'bold', color: '#555555', fontFamily: 'bengali', textAlign: 'right' },
    { id: 'amount_val', type: 'placeholder', x: 58, y: 112, width: 110, height: 14, placeholder: '{amount}', fontSize: 11, fontWeight: 'bold', color: '#000000', fontFamily: 'bengali' },
    { id: 'txn_label', type: 'text', x: 10, y: 127, width: 45, height: 12, content: 'TXN:', fontSize: 8, fontWeight: 'bold', color: '#555555', textAlign: 'right' },
    { id: 'txn_val', type: 'placeholder', x: 58, y: 127, width: 120, height: 12, placeholder: '{transaction_id}', fontSize: 7, color: '#111111' },
    { id: 'date_label', type: 'text', x: 10, y: 140, width: 45, height: 13, content: 'তারিখ:', fontSize: 9, fontWeight: 'bold', color: '#555555', fontFamily: 'bengali', textAlign: 'right' },
    { id: 'date_val', type: 'placeholder', x: 58, y: 140, width: 110, height: 13, placeholder: '{date}', fontSize: 9, color: '#111111', fontFamily: 'bengali' },
    { id: 'status_label', type: 'text', x: 10, y: 154, width: 45, height: 13, content: 'স্ট্যাটাস:', fontSize: 9, fontWeight: 'bold', color: '#555555', fontFamily: 'bengali', textAlign: 'right' },
    { id: 'status_val', type: 'placeholder', x: 58, y: 154, width: 110, height: 13, placeholder: '{status}', fontSize: 9, fontWeight: 'bold', color: '#22c55e', fontFamily: 'bengali' },
    { id: 'qr', type: 'qr', x: 218, y: 56, width: 52, height: 52, content: '' },
    { id: 'sig_collector', type: 'text', x: 10, y: 168, width: 80, height: 12, content: '{collector_name}', fontSize: 7, color: '#888888', textAlign: 'center', fontFamily: 'bengali' },
    { id: 'sig_approver', type: 'text', x: 190, y: 168, width: 80, height: 12, content: '{approver_name}', fontSize: 7, color: '#888888', textAlign: 'center', fontFamily: 'bengali' },
  ],
};
